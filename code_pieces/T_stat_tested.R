...
# Plot densities
plot(density(vect_al), xlim=c(-5,5))
points(x=seq(-5,5, by=0.1), y=dnorm(x=seq(-5,5, by=0.1), sd=sqrt(var_al)))
...
plot(density(vect_al_simple), xlim=c(-0.1,0.1))
