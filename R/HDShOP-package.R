...
#' \code{\link{MVShrinkPortfolio}}, \code{\link{CovarEstim}} and
#' \code{\link{MeanEstim}}. MVShrinkPortfolio creates mean-variance
...
#' @section Methods:
#'
#' MeanEstim: \insertCite{BOP2019}{HDShOP}, James-Stein and Bayes-Stein
#' estimators \insertCite{Jorion1986}{HDShOP}.
#'
#' CovarEstim: \insertCite{BGP2014}{HDShOP}, \insertCite{LW2020}{HDShOP}.
#'
#' MVShrinkPortfolio: \insertCite{BDOPS2021}{HDShOP},
#' \insertCite{BDPS2019}{HDShOP}.
#'
#' MeanVar_portfolio.
#'
#'
