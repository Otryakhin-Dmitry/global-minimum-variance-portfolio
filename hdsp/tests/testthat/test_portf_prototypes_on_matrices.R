...
test_that("All prototypes are valid ExUtil_portfolio objects", {
  ...
  # (i-)Covariance
  expect_s3_class(object=validate_ExUtil_portfolio(port_LW02), class="ExUtil_portfolio", exact = FALSE)
  expect_s3_class(object=validate_ExUtil_portfolio(port_BGP14), class="ExUtil_portfolio", exact = FALSE)
  expect_s3_class(object=validate_ExUtil_portfolio(port_BGP16), class="ExUtil_portfolio", exact = FALSE)

  # Mean
  expect_s3_class(object=validate_ExUtil_portfolio(port_BS), class="ExUtil_portfolio", exact = FALSE)
  expect_s3_class(object=validate_ExUtil_portfolio(port_JS), class="ExUtil_portfolio", exact = FALSE)
  expect_s3_class(object=validate_ExUtil_portfolio(port_BOP), class="ExUtil_portfolio", exact = FALSE)

  # Weights
  expect_s3_class(object=validate_ExUtil_portfolio(port_BDOPS20), class="ExUtil_portfolio", exact = FALSE)
})
